---
title: "华沙地标Intraco大楼将拆除 🏗️"
date: 2026-04-05T22:07:07.249459+00:00
...
Budynek Intraco w Warszawie nie będzie zabytkiem. Właściciel planuje rozbiórkę wieżowca. Na jego miejscu powstanie nowoczesny biurowiec.

<audio controls style="width: 100%; margin: 1rem 0; display: block;">
  <source src="/PL-life-brief/audio/wi-intraco-denied-heritage-status.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>


**💡 关键表达 (Key Expressions)：**
- **zabytkowy**: 历史悠久的/古迹的，常用来形容受保护的老建筑。
- **rozbiórka**: 拆除，指拆毁旧建筑或设施。
- **na jego miejscu**: 在它的原址上，用于描述旧址上的新建设。
- **powstać**: 产生/兴建，常用于描述新建筑落成或项目开始。
- **właściciel**: 业主，指拥有某项财产或房产的人。
