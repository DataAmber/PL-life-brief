---
title: "离奇冤案！真凶已认罪，他却还在坐牢 ⚖️"
date: 2026-04-19T07:20:22.244843+00:00
...
Piotr Pytel przebywa w więzieniu od ponad dwudziestu lat. Został skazany za zabójstwo w Monachium, ale on twierdzi, że jest niewinny. Prawdziwy sprawca przyznał się do tej zbrodni przed sądem. Mimo to, polski więzień nadal odbywa wyrok dożywocia. Ta sprawa jest bardzo trudna i smutna.

<audio controls style="width: 100%; margin: 1rem 0; display: block;">
  <source src="/PL-life-brief/audio/fakt-8fvz3jm.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>


**💡 关键表达 (Key Expressions)：**
- **odbywać wyrok**: 服刑/执行判决。例如：On odbywa wyrok w Rzeszowie (他在热舒夫服刑)。
- **przyznać się do zbrodni**: 承认罪行。这是法律报道中的常用词，与“zbrodnia”（重罪）搭配使用。
- **wykluczające się wyroki**: 相互矛盾的判决。形容法律文件中证据或结论逻辑不符的情况。
- **znajdować się za kratami**: 在监狱里。这是一种地道的波兰语表达方式，即“在铁窗后”。
- **wymknąć się spod kontroli**: 失控。描述局势（如抢劫案）超出了预期范围。
