---
title: "华沙网红直播募捐破纪录 🚀"
date: 2026-04-28T04:34:33.017299+00:00
...
Patryk Garkowski zorganizował długi stream na YouTube. Przez dziewięć dni zbierał pieniądze na walkę z rakiem. Wiele znanych osób wzięło udział w tym wydarzeniu. Łącznie zebrano ponad 250 milionów złotych. To był największy charytatywny stream w historii. Polacy pokazali, że potrafią pomagać.

<audio controls style="width: 100%; margin: 1rem 0; display: block;">
  <source src="/PL-life-brief/audio/wi-how-latwogangs-nine-day-stream-changed-the-internet.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>


**💡 关键表达 (Key Expressions)：**
- **zbiórka pieniędzy**: 筹款，通常指为了某个目标筹集资金。
- **wziąć udział w czymś**: 参加某事，是口语和书面语中非常高频的词组。
- **wspierać kogoś**: 支持某人/某事，常用于公益或鼓励他人的语境。
- **pobić rekord**: 打破记录，用于体育或统计数据相关的成就。
- **pokazać solidarność**: 展示团结，常用于慈善或社会运动。
